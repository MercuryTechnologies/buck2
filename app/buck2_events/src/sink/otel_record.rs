...
fn push_command_end(a: &mut Attrs, c: &buck2_data::CommandEnd) {
    ...
    match &c.data {
        ...
        Some(buck2_data::command_end::Data::HydrationPageOut(e)) => {
            a.string("command_end.kind", "hydration_page_out");
            push_hydration_page_out_command_end(a, e);
        }
        None => {}
    }
}
...
fn push_hydration_page_out_command_end(
    _a: &mut Attrs,
    _e: &buck2_data::HydrationPageOutCommandEnd,
) {
}
